      ...
      switch (client) {
          ...
          for (let i = 1; i <= 4; i++) {
            if (i == 1) {
              newHTML += `<div class="carousel-item active">
                    <img src="./assets/img/clients/BARRIO EL CAZAL. UF10/${i}.JPG" class="d-block w-100" alt="...">
                </div>
                `;
            } else {
        ...
        case "UF 017 - Highland - Proyecto":
          for (let i = 1; i <= 4; i++) {
            if (i == 1) {
              newHTML += `<div class="carousel-item active">
                      <img src="./assets/img/clients/BARRIO EL CAZAL . UF163/${i}.JPG" class="d-block w-100" alt="...">
                  </div>
                  `;
            } else {
              newHTML += `<div class="carousel-item">
        ...
        case "UF 026 - Terralagos - Proyecto":
          for (let i = 1; i <= 4; i++) {
            if (i == 1) {
              newHTML += `<div class="carousel-item active">
                          <img src="./assets/img/clients/BARRIO EL CAZAL. UF158/${i}.JPG" class="d-block w-100" alt="...">
                      </div>
                      `;
            } else {
              newHTML += `<div class="carousel-item">
